  ...
  def create
    begin
      ...
      if check_annotation_exist_or_not
        exiting_annotation = Annotation.find_by_article_id_and_annotation_category_id_and_source_text(article_id, annotation_category_id, source_text).present?


        exiting_annotation.update_attributes(:source_text => annotation[:source_text], 
