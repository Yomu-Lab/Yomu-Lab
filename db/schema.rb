...
ActiveRecord::Schema.define(version: 20160110192810) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "ui_language",            limit: 255
    t.string   "original_language",      limit: 255
    t.string   "target_language",        limit: 255
    t.string   "open_id",                limit: 255
    t.boolean  "password_manually_set",  limit: 1
